...
function createCash() {
  if (World.frameCount % 200 == 0) {
   //Modificar las posiciones del dinero 
    ...
    var cash = createSprite(width-200,height+400,40,10);
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(width-600,height+400,40,10);
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(width-1250,height+400,40,10);
    jwellery.y=Math.round(random(50, 350));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(width-900,height+400,40,10);
    sword.y=Math.round(random(50, 350));
